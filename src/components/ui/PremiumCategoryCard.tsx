  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        {/* Icon */}
        <div className="absolute top-4 left-4 p-3 rounded-2xl bg-white/90 backdrop-blur-sm shadow-lg transition-all duration-500">
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-border/50">
          ...
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 text-white group-hover:shadow-lg transition-all duration-300">
            <ArrowRight 
